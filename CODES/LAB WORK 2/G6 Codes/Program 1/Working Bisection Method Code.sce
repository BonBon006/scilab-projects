clc
disp("Welcome to Group 6 Working Bisection Method Root Approximator 1.0 (G6-WBMRA 1.0)!")
...
disp("")
disp("How to Use G6-WBMRA 1.0: Input polynomial function in this format: poly([a,b,c,-->nth],%x%,%coeff%)")
disp("")
...
elseif ANSWER==0 then
    clc 
    disp("You have aborted the program. Thank you for using G6-WBMRA 1.0!")
    abort
else 
    clc
