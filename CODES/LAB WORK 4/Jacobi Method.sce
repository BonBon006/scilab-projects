...
x1_3rd_rounded_absolute=abs(x2_3rd_rounded)
x1_3rd_rounded_absolute=abs(x3_3rd_rounded)
x1_4th_rounded_absolute=abs(x1_4th_rounded)
x1_4th_rounded_absolute=abs(x2_4th_rounded)
x1_4th_rounded_absolute=abs(x3_4th_rounded)
...
if x1_divergence_final_checking>x1_divergence_initial_checking & x2_divergence_final_checking>x2_divergence_initial_checking & x3_divergence_final_checking>x3_divergence_initial_checking then
    disp("")
    disp("ERROR: Divergence of approximations are occuring! This may be because of the matrix provided, which may not be strictly diagonally dominant!")
...
if x1_25th_rounded==x1_24th_rounded & x2_25th_rounded==x2_24th_rounded & x3_25th_rounded==x3_24th_rounded then
    ...
    disp("RECOMMENDED ACTION: Switch to Gauss-Seidel Method. You can also wa")
end