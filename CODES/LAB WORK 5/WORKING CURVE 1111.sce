...
while clock1>0
    ...
    elseif ANSWER1==231 then
        ...
        if ANSWER11==123 then
            ...
            mprintf("\n")
            mprintf("\n")
            disp("y = ("+string(a1)+")x^2 + ("+string(b1)+")x + ("+string(c1)+").", "The required best fit curve is:")
            mprintf("\n")
            mprintf("\n\n\t\t        Comparison Table\n");
            mprintf("\t\nXi\t\tYi\t\tYi (Calculated)\t\tDistance Margin \n");
        ...
        elseif ANSWER11==231 then
            ...
            while clock2>0
                ...
                if ANSWER22==123 then
                    ...
                    b=b_equation_2/10000

                    x=X'
                    y_equation=b*(m^x) // y = ab^x ; ( a = B = b ; b = M = m ; x = X = x )
                    ...
                    mprintf("\n")
                    mprintf("\n")
                    disp("y = ("+string(b)+")[("+string(m)+")^x].", "The required best fit curve is:")
                    mprintf("\n")
                    mprintf("\n\n\t\t        Comparison Table\n");
                    mprintf("\t\nXi\t\tYi\t\tYi (Calculated)\t\tDistance Margin \n");
                    for s2=1:length(X)
                ...
                elseif ANSWER22==231 then
                    ...
                    x=X1'
                    y_equation=b*(x^m) // y = ax^b ; ( a = B = b ; b = M = m ; x = X = ln(x) )
                    y_equation_1=y_equation*10000
                    y_equation_2=round(y_equation_1)
                    y=y_equation_2/10000
                    y_absolute=abs(y)
                    ...
                    mprintf("\n")
                    mprintf("\n")
                    disp("y = ("+string(b)+")[x^("+string(m)+")].", "The required best fit curve is:")
                    mprintf("\n")
                    mprintf("\n\n\t\t        Comparison Table\n");
                    mprintf("\t\nXi\t\tYi\t\tYi (Calculated)\t\tDistance Margin \n");
                    for s2=1:length(X)
                    ...
                    if ANSWER2==1 then
                        ...
                        while clock3>0
                            ...
                            X_user_values=input (" Please input your desired Xi matrix:  ")
                            x2=X_user_values'
                            y2_equation=b*(x^m) // y = ax^b ; ( a = B = b ; b = M = m ; x = X = ln(x) )
                            y2_equation_1=y2_equation*10000
                            y2_equation_2=round(y2_equation_1)
                            y2=y2_equation_2/10000
                            mprintf("\n\t   Results Table\n");
                ...
                elseif ANSWER22==321 then
                    ...
                    mprintf("\n")
                    mprintf("\n")
                    disp("y = e^("+string(b)+") + ("+string(m)+")x.", "The required best fit curve is:")
                    mprintf("\n")
                    mprintf("\n\n\t\t        Comparison Table\n");
                    mprintf("\t\nXi\t\tYi\t\tYi (Calculated)\t\tDistance Margin \n");
                    for s2=1:length(X)
                    ...
                    if ANSWER2==1 then
                        ...
                        while clock3>0
                            ...
                            X_user_values=input (" Please input your desired Xi matrix:  ")
                            x2=X_user_values'
                            y2_equation=b+(m*x) // y = ax^b ; ( a = B = b ; b = M = m ; x = X = ln(x) )
                            y2_equation_1=y2_equation*10000
                            y2_equation_2=round(y2_equation_1)
                            y2=y2_equation_2/10000
                            mprintf("\n\t   Results Table\n");
                ...
                if selec_page==1 & selec_log_page==0 then
                    break
                elseif selec_page==0 & selec_log_pag==1 then
                    continue
                end
            end
        end
