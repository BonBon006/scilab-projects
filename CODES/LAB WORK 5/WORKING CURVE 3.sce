...
while clock1>0
    clc
    disp("Welcome to Group 6 MultiCurveFitter 1.0.1! ")
    mprintf("\n")
    mprintf("\n")
        ...
        elseif ANSWER11==231 then
            ...
            while clock2>0
                ...
                if ANSWER22==123 then
                    ...
                    mprintf("\n")
                    mprintf("\n")
                    disp("y = ("+string(b1)+")[("+string(m)+")^x].", "The required best fit curve is:")
                    mprintf("\n")
                    mprintf("\n\n\t\t        Comparison Table\n");
                    mprintf("\t\nXi\t\tYi\t\tYi (Calculated)\t\tDistance Margin \n");
                    for s2=1:length(X)
                ...
                elseif ANSWER22==231 then
                    ...
                    mprintf("\n")
                    mprintf("\n")
                    disp("y = ("+string(b1)+")[x^("+string(m)+")].", "The required best fit curve is:")
                    mprintf("\n")
                    mprintf("\n\n\t\t        Comparison Table\n");
                    mprintf("\t\nXi\t\tYi\t\tYi (Calculated)\t\tDistance Margin \n");
                    for s2=1:length(X)
                ...
                elseif ANSWER22==321 then
                    ...
                    mprintf("\n")
                    mprintf("\n")
                    disp("y = e^("+string(b1)+") + ("+string(m)+")x.", "The required best fit curve is:")
                    mprintf("\n")
                    mprintf("\n\n\t\t        Comparison Table\n");
                    mprintf("\t\nXi\t\tYi\t\tYi (Calculated)\t\tDistance Margin \n");
                    for s2=1:length(X)
